...
@RestController
@RequestMapping("/api/v1/employee")  // API endpoint for employee operations
public class EmployeeController {
    ...
    // Add methods to interact with the EmployeeService here
    @PostMapping("/add")
...
//    http://localhost:8080/api/v1/employee?id=1  query parameters
        ...
        public ResponseEntity<EmployeeDto > updateEmployee(
            @RequestParam Long id,
//            @RequestBody Employee  employee the data is present here rather use then I used Dto @EmployeeEntity
    ...
    //    http://localhost:8080/api/v1/employee?pageSize=3&pageNo=1&sortBy=email&sortDir=asc  query parameters asc=ascending
    @GetMapping
